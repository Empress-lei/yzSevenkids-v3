...
;layui.define(function (e) {
    ...
    u.prototype.type = function () {
        ...
        var n = a.pages > t ? Math.ceil((a.curr + (t > 1 ? 1 : 0)) / (t > 0 ? t : 1)) : 1, i = {
            prev: function () {
                return a.prev ? '<a href="javascript:;" class="layui-laypage-prev pageUp' + (1 == a.curr ? " " + r : "") + '" data-page="' + (a.curr - 1) + '">' + a.prev + "</a>" : ""
            }(), page: function () {
                var e = [];
                if (a.count < 1)return "";
                ...
                return a.next ? '<a href="javascript:;" class="layui-laypage-next pageDown' + (a.curr == a.pages ? " " + r : "") + '" data-page="' + (a.curr + 1) + '">' + a.next + "</a>" : ""
